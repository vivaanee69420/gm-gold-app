...
export function ReferredStatusScreen() {
  ...
  return (
    <Screen>
      ...
      <Body muted style={{ marginTop: space(6), fontSize: 12 }}>
        After your treatment you’ll get your own gold card — and your referrals pay you back.
      </Body>
    </Screen>
  );
}
...
const styles = StyleSheet.create({
  ...
  groupLabel: { color: colors.mist, fontSize: 12, letterSpacing: 0.8, textTransform: 'uppercase', marginBottom: space(2), marginTop: space(2) },
  ...
  consentRow: { flexDirection: 'row', gap: space(3), marginVertical: space(4), alignItems: 'flex-start' },
  checkbox: {
    width: 24,
    height: 24,
    borderRadius: 6,
